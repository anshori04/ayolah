...
col1.area_chart(data['Unit #1 - A coal feeder flow feedback'], width = 100, height = 200)
col2.area_chart(data['Unit #1 - B coal feeder flow feedback'], width = 100, height = 200)
col3.area_chart(data['Unit #1 - C coal feeder flow feedback'], width = 100, height = 200)
col1.area_chart(data['Unit #1 - D coal feeder flow feedback'], width = 100, height = 200)
col2.area_chart(data['Unit #1 - E coal feeder flow feedback'], width = 100, height = 200)
col3.area_chart(data['Unit #1 - F coal feeder flow feedback'], width = 100, height = 200)
col1.area_chart(data['Unit #2 - A coal feeder flow feedback'], width = 100, height = 200)
col2.area_chart(data['Unit #2 - B coal feeder flow feedback'], width = 100, height = 200)
col3.area_chart(data['Unit #2 - C coal feeder flow feedback'], width = 100, height = 200)
col1.area_chart(data['Unit #2 - D coal feeder flow feedback'], width = 100, height = 200)
col2.area_chart(data['Unit #2 - E coal feeder flow feedback'], width = 100, height = 200)
col3.area_chart(data['Unit #2 - F coal feeder flow feedback'], width = 100, height = 200)